...
# Scope instrumentation to the module under test: torrent_parser's parse /
# encode / create logic is the target; instrumenting stdlib imports would only
# add non-target edges and startup cost.
